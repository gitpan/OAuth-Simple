# This Makefile is for the OAuth::Simple extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/OAuth/Simple.pm]
...
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/OAuth/Simple.pm]
#     clean => { FILES=>q[OAuth-Simple-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/OAuth/Simple.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/OAuth
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/OAuth
...
TO_INST_PM = lib/OAuth/Simple.pm

PM_TO_BLIB = lib/OAuth/Simple.pm \
...
DISTNAME = OAuth-Simple
DISTVNAME = OAuth-Simple-1.0
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/OAuth/Simple.pm $(INST_MAN3DIR)/OAuth::Simple.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Simple OAuth authorization on your site'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: OAuth-Simple' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Simple OAuth authorization on your site",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Alexander Babenko <foxcool@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "OAuth-Simple",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Simple OAuth authorization on your site</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/OAuth/Simple.pm blib/lib/OAuth/Simple.pm 
